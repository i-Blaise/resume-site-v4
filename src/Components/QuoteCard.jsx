export default function QuoteCard() {
    return (
        <div className="flex flex-col lg:flex-row md:flex-rowjustify-between mt-10 bg-[#3F2E3E7D] rounded-[22px] p-6 py-12 w-full gap-4 lg:gap-0 md:gap-0 text-left">
            <div className="lg:w-[60%] md:w-[60%] text-left lg:px-12 md:px-12">
            ...
            <div className="flex flex-col lg:w-[40%] md:w-[40%]text-left gap-6">
                <p className="font-Inter-Regular lg:text-[19.5px] md:text-[19.5px] uppercase font-medium text-[14px] text-[#F0CCCC6B]">
                ...
                <p className="font-Inter-Regular text-[#EFE1D159]">Richie Nainaney / OrikamiLab</p>
            </div>
        </div>
    )
}