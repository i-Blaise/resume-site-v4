    ...
    return (
        <div className="flex flex-col lg:flex-row md:flex-row gap-6 justify-between items-center mt-6">
            <div 
                ...
                className="relative h-[518px] w-[310px] lg:w-[520px] md:h-[520px] bg-cover bg-center bg-no-repeat bg-[#450F2B82] bg-blend-overlay rounded-[13px]"
            ...
            <div 
                ...
                data-aos-delay="200"         // ms delay
                data-aos-duration="800"
                className="relative h-[518px] w-[310px] lg:w-[828px] md:h-[520px] bg-cover bg-center bg-no-repeat bg-[#450F2B82] bg-blend-overlay rounded-[13px]"
            style={{ backgroundImage: `url(${WorkImg1})` }}>
            </div>
        </div>
    )
