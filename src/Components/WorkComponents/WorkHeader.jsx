export default function WorkHeader() {
    return (
        <div className="flex flex-col md:flex-row lg:flex-row h-[251px] lg:h-[240px] md:h-[240px] bg-[#A78295] rounded-[22px] py-10 lg:px-16 md:px-16 px-2">
            <div className="flex justify-start items-center lg:w-[368px] md:w-[368px] h-[145px]">
                <h1 className="font-Inter-Medium lg:text-[121px] md:text-[121px] text-[41px] text-transparent bg-clip-text bg-[#3F2E3E59]">01</h1>
            </div>
            <div className="flex flex-col justify-start lg:w-[550px] h-[145px] px-2 py-4 text-left">
